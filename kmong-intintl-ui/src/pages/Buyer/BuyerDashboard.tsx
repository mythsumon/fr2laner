...
export const BuyerDashboard = () => {
  ...
  const filteredOrders = useMemo(() => {
    return orders.filter((order) => {
      ...
      const matchesSearch = order.service.toLowerCase().includes(searchOrders.toLowerCase()) || order.seller.toLowerCase().includes(searchOrders.toLowerCase()) || order.id.toLowerCase().includes(searchOrders.toLowerCase());
                ...
                {[
                  ...
                  <div key={step} className="request-step">
                    ...
                    <div>
                      ...
                      <p className="request-step__subtitle">Provide details {index === 0 ? "about your project scope" : ""}</p>
                    </div>
                  </div>
                ))}
              </div>
