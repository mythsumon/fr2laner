...
export const MyServicesPage = () => {
  ...
  const handleEdit = (id: string) => {
    window.location.href = `/expert/services/${id}/edit`;
  };
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <Link href={`/services/${service.id}`} target="_blank">
                      <Button
                        ...
                        size="small"
                        shape="round"
                        className="gap-2 border border-[#2E5E99] bg-white text-sm font-medium text-[#2E5E99] hover:bg-[#E9EEF8]"
                      >
                        <Eye className="size-4" />
                        <span className="hidden sm:inline">공개 페이지 보기</span>
                      </Button>
                    </Link>
                    {service.status === "Active" && (
                      <Button
